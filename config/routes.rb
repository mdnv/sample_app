...
Rails.application.routes.draw do
  # scope "/:locale" do
  scope '(:locale)', locale: /en|de|fr|vi/ do
    ...
    resources :guest_cart_items, only: %i[create update destroy]
    get 'cart', to: 'cart#index'
    resources :wish_items, only: %i[create destroy]
    resources :guest_wish_items, only: %i[create destroy]
    get 'wish', to: 'wish#index'
    resources :orders
